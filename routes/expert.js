...
router.post('/', authMiddleware, async (req, res) => {
  try {
    ...
    const qLower = question.trim().toLowerCase().replace(/[^a-z ]/g, '').trim();
    const isGreeting = ['hi', 'hello', 'hello hello', 'hey', 'namaste', 'ram ram', 'namaskar', 'good morning', 'good afternoon', 'good evening', 'hi dr', 'hello dr'].includes(qLower);
    ...
    if (isGreeting) {
      if (language === 'mr') {
        answer = "**कृषी सल्लागार मार्गदर्शन (Dr. Patil):**\nनमस्कार! मी डॉ. पाटील. आज मी तुमच्या पिकांबद्दल तुम्हाला कशी मदत करू शकेन? कृपया तुमच्या पिकाची समस्या सांगा.";
      } else if (language === 'hi') {
        answer = "**कृषि विशेषज्ञ सलाह (Dr. Patil):**\nनमस्ते! मैं डॉ. पाटिल हूँ। आज मैं आपकी फसलों के संबंध में कैसे मदद कर सकता हूँ? कृपया अपनी समस्या बताएं।";
      } else {
        answer = "**Agricultural Specialist Advice (Dr. Patil):**\nHello! I am Dr. Patil. How can I assist you with your crops today? Please describe your crop issue.";
      }
    } else {
      try {
